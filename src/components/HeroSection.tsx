...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[calc(100vh-4rem)] flex flex-col justify-center pt-16 pb-24">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(45%_25%_at_50%_50%,rgba(59,130,246,0.12),rgba(0,0,0,0))]" />
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Button 
                className="gap-2 hover-glow group relative overflow-hidden"
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Button variant="outline" className="hover-glow">Contact Me</Button>
            </motion.div>
          </motion.div>
        </motion.div>
      </motion.div>
